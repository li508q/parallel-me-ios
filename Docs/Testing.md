...
- Roundtable action availability and controls presentation explain incomplete openings, missing task frames, busy state, action labels, icons, prompts, and input-dependent send gates before submitting roundtable moves or entering inquiry.
