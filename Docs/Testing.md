...
Current smoke coverage includes 22 checks across flow rules, provider configuration, secure settings persistence, deduplication, settlement readiness, user settlement revisions, archive summaries, repositories, session events, and all demo roundtable move types.
